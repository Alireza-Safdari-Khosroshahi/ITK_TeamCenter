...
#define ITEM_find_item find_item
    ...
    if (n_instances > 0)
    {
        for (ii = 0; ii < n_instances; ii++)
        {
            ...
            if ((type == folder_type) || (type == newstuff_type))
            {
				...
				FL_remove(folder_type, ref_instances[ii]);
...
void print_Item_name (tag_t item)
{
...
void  serch_And_Print_Items (char* search_id)
{
	char *item_name="Abbas";
...
static void do_it(void)
{
    ...
    do
    {
		...
		*/
		...
		char* search_id = "000300";		
		serch_And_Print_Items(search_id);
