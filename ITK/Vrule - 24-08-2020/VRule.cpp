...
static void print_Variant_Rule_Text (tag_t  irev_tag)
{
	...
	if ( istatus ==  ITK_ok )
        {
			...
			if ( n_item > 0 )
			{
				...
				{		
						if (AOM_ask_value_string(item_tags[i],"item_id",&objectname)!= ITK_ok )PrintErrorStack();
						...
						*/
						if (strcmp(objectname, "PR00000003") == 0)
						{
							//printf("Name: %s  \n", objectname);
