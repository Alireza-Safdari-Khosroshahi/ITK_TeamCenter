...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPADREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPADREVISION_HXX
...
class TCSOACMTPADTWPMODELMNGD_API MEPADRevision : public Teamcenter::Soa::Client::Model::MEProcessRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPADRevision")

   virtual ~MEPADRevision();
};
            }
        }
    }
