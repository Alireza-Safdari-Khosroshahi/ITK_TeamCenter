...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ADSDESIGN_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ADSDESIGN_REVISION_HXX
...
class TCSOAADSFOUNDATIONMODELMNGD_API ADSDesign_Revision : public Teamcenter::Soa::Client::Model::Design_Revision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ADSDesign_Revision")

   virtual ~ADSDesign_Revision();
};
            }
        }
    }
