...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ISSPECREVISIONATTR_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ISSPECREVISIONATTR_HXX
...
class TCSOASPECMGRMODELMNGD_API ISSpecRevisionAttr : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ISSpecRevisionAttr")

   virtual ~ISSpecRevisionAttr();
};
            }
        }
    }
