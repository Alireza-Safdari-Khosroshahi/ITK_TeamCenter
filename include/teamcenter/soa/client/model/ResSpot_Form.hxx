...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_RESSPOT_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_RESSPOT_FORM_HXX
...
class TCSOAGMOMODELMNGD_API ResSpot_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ResSpot_Form")

   virtual ~ResSpot_Form();
};
            }
        }
    }
