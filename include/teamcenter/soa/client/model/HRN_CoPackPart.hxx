...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_COPACKPART_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_COPACKPART_HXX
...
class TCSOAHRNMODELMNGD_API HRN_CoPackPart : public Teamcenter::Soa::Client::Model::Item
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_CoPackPart")

   virtual ~HRN_CoPackPart();
};
            }
        }
    }
