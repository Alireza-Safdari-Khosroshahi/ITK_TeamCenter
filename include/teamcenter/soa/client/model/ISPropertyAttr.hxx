...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ISPROPERTYATTR_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ISPROPERTYATTR_HXX
...
class TCSOASPECMGRMODELMNGD_API ISPropertyAttr : public Teamcenter::Soa::Client::Model::Form
{
public:
    int get_property_id();
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ISPropertyAttr")

   virtual ~ISPropertyAttr();
};
            }
        }
    }
