...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_TOOL_REVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_TOOL_REVISION_MASTER_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Tool_Revision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Tool_Revision_Master")

   virtual ~CORP_Tool_Revision_Master();
};
            }
        }
    }
