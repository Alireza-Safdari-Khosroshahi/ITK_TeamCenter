...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ICM0_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ICM0_HXX
...
class TCSOACLIENTMNGD_API Icm0 : public Teamcenter::Soa::Client::Model::POM_object
{
public:
    ...
    const std::string& get_sm101();
    const std::string& get_sm102();
    const std::string& get_sm103();
    const std::string& get_sm104();
    const std::string& get_sm105();
    const std::string& get_sm106();
    const std::string& get_sm107();
    const std::string& get_sm108();
    const std::string& get_sm109();
    const std::string& get_sm110();
    const std::string& get_sm111();
    const std::string& get_sm112();
    const std::string& get_sm113();
    const std::string& get_sm114();
    const std::string& get_sm115();
    const std::string& get_sm116();
    const std::string& get_sm117();
    const std::string& get_sm118();
    const std::string& get_sm119();
    const std::string& get_sm120();
    const std::string& get_sm121();
    const std::string& get_sm122();
    const std::string& get_sm123();
    const std::string& get_sm124();
    const std::string& get_sm125();
    const std::string& get_sm126();
    const std::string& get_sm127();
    const std::string& get_sm128();
    const std::string& get_sm129();
    const std::string& get_sm130();
    const std::string& get_sm131();
    const std::string& get_sm132();
    const std::string& get_sm133();
    const std::string& get_sm134();
    const std::string& get_sm135();
    const std::string& get_sm136();
    const std::string& get_sm137();
    const std::string& get_sm138();
    const std::string& get_sm139();
    const std::string& get_sm140();
    const std::string& get_sm141();
    const std::string& get_sm142();
    const std::string& get_sm143();
    const std::string& get_sm144();
    const std::string& get_sm145();
    const std::string& get_sm146();
    const std::string& get_sm147();
    const std::string& get_sm148();
    const std::string& get_sm149();
    const std::string& get_sm150();
    const std::string& get_sm151();
    const std::string& get_sm152();
    const std::string& get_sm153();
    const std::string& get_sm154();
    const std::string& get_sm155();
    const std::string& get_sm156();
    const std::string& get_sm157();
    const std::string& get_sm158();
    const std::string& get_sm159();
    const std::string& get_sm160();
    const std::string& get_sm161();
    const std::string& get_sm162();
    const std::string& get_sm163();
    const std::string& get_sm164();
    const std::string& get_sm165();
    const std::string& get_sm166();
    const std::string& get_sm167();
    const std::string& get_sm168();
    const std::string& get_sm169();
    const std::string& get_sm170();
    const std::string& get_sm171();
    const std::string& get_sm172();
    const std::string& get_sm173();
    const std::string& get_sm174();
    const std::string& get_sm175();
    const std::string& get_sm176();
    const std::string& get_sm177();
    const std::string& get_sm178();
    const std::string& get_sm179();
    const std::string& get_sm180();
    const std::string& get_sm181();
    const std::string& get_sm182();
    const std::string& get_sm183();
    const std::string& get_sm184();
    const std::string& get_sm185();
    const std::string& get_sm186();
    const std::string& get_sm187();
    const std::string& get_sm188();
    const std::string& get_sm189();
    const std::string& get_sm190();
    const std::string& get_sm191();
    const std::string& get_sm192();
    const std::string& get_sm193();
    const std::string& get_sm194();
    const std::string& get_sm195();
    const std::string& get_sm196();
    const std::string& get_sm197();
    const std::string& get_sm198();
    const std::string& get_sm199();
    const std::string& get_sm200();
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Icm0")
