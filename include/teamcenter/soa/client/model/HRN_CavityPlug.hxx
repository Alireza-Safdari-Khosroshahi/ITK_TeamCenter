...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_CAVITYPLUG_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_CAVITYPLUG_HXX
...
class TCSOAHRNMODELMNGD_API HRN_CavityPlug : public Teamcenter::Soa::Client::Model::Item
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_CavityPlug")

   virtual ~HRN_CavityPlug();
};
            }
        }
    }
