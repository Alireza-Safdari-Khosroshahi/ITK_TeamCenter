...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_NXAFEM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_NXAFEM_HXX
...
class TCSOACLIENTMNGD_API NXAFEM : public Teamcenter::Soa::Client::Model::Dataset
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("NXAFEM")
