...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFINTREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFINTREVISION_HXX
...
class TCSOACCDMMODELMNGD_API ParmDefIntRevision : public Teamcenter::Soa::Client::Model::ParmDefRevision
{
public:
    Teamcenter::Soa::Common::AutoPtr<Table> get_maxValues();
    Teamcenter::Soa::Common::AutoPtr<Table> get_minValues();
    int get_resolution_numerator();
    int get_resolution_denominator();
    bool get_isSigned();
    Teamcenter::Soa::Common::AutoPtr<Table> get_initialValues();
    Teamcenter::Soa::Common::AutoPtr<TableDefinition> get_tableDefinition();


   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ParmDefIntRevision")

   virtual ~ParmDefIntRevision();
};
            }
        }
    }
