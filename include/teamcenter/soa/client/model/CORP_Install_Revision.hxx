...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_INSTALL_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_INSTALL_REVISION_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Install_Revision : public Teamcenter::Soa::Client::Model::ItemRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Install_Revision")

   virtual ~CORP_Install_Revision();
};
            }
        }
    }
