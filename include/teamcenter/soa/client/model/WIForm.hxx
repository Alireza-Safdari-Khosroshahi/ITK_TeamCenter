...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_WIFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_WIFORM_HXX
...
class TCSOACLIENTMNGD_API WIForm : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("WIForm")
