...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFDATEREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFDATEREVISION_HXX
...
class TCSOACCDMMODELMNGD_API ParmDefDateRevision : public Teamcenter::Soa::Client::Model::ParmDefRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ParmDefDateRevision")

   virtual ~ParmDefDateRevision();
};
            }
        }
    }
