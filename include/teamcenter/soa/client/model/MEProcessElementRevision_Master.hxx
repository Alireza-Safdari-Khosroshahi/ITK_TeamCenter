...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPROCESSELEMENTREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPROCESSELEMENTREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEProcessElementRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEProcessElementRevision_Master")

   virtual ~MEProcessElementRevision_Master();
};
            }
        }
    }
