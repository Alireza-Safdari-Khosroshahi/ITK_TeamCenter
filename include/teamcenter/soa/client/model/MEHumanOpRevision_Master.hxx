...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEHUMANOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEHUMANOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEHumanOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEHumanOpRevision_Master")

   virtual ~MEHumanOpRevision_Master();
};
            }
        }
    }
