...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPRPROCESSREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPRPROCESSREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEPrProcessRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPrProcessRevision_Master")

   virtual ~MEPrProcessRevision_Master();
};
            }
        }
    }
