...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_BLDB0_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_BLDB0_HXX
...
class TCSOACLIENTMNGD_API Bldb0 : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Bldb0")
