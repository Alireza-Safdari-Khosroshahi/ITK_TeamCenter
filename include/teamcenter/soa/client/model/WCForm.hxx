...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_WCFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_WCFORM_HXX
...
class TCSOACLIENTMNGD_API WCForm : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("WCForm")
