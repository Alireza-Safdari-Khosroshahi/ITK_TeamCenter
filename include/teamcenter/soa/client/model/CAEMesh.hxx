...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CAEMESH_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CAEMESH_HXX
...
class TCSOACLIENTMNGD_API CAEMesh : public Teamcenter::Soa::Client::Model::Dataset
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CAEMesh")
