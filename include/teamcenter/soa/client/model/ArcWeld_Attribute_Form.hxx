...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ARCWELD_ATTRIBUTE_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ARCWELD_ATTRIBUTE_FORM_HXX
...
class TCSOACLIENTMNGD_API ArcWeld_Attribute_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ArcWeld_Attribute_Form")

   virtual ~ArcWeld_Attribute_Form();
};
            }
        }
    }
