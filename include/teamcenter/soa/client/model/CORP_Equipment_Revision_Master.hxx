...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_EQUIPMENT_REVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_EQUIPMENT_REVISION_MASTER_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Equipment_Revision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Equipment_Revision_Master")

   virtual ~CORP_Equipment_Revision_Master();
};
            }
        }
    }
