...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEWELDOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEWELDOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEWeldOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEWeldOpRevision_Master")

   virtual ~MEWeldOpRevision_Master();
};
            }
        }
    }
