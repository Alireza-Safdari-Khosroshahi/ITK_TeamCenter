...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_DC_SKDDMLREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_DC_SKDDMLREVISION_HXX
...
class TCSOACONTMGMTS1000DMODELMNGD_API DC_SkdDMLRevision : public Teamcenter::Soa::Client::Model::DC_TopicRevision
{
public:
    const std::string& get_skddiyear();
    const std::string& get_skddmltype();
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("DC_SkdDMLRevision")

   virtual ~DC_SkdDMLRevision();
};
            }
        }
    }
