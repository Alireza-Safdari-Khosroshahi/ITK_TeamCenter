...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_VEHICLE_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_VEHICLE_REVISION_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Vehicle_Revision : public Teamcenter::Soa::Client::Model::ItemRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Vehicle_Revision")

   virtual ~CORP_Vehicle_Revision();
};
            }
        }
    }
