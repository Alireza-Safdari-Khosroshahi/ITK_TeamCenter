...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPRLINEPROCESSREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPRLINEPROCESSREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEPrLineProcessRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPrLineProcessRevision_Master")

   virtual ~MEPrLineProcessRevision_Master();
};
            }
        }
    }
