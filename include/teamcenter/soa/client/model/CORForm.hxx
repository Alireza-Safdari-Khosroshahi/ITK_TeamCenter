...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORFORM_HXX
...
class TCSOACLIENTMNGD_API CORForm : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORForm")
