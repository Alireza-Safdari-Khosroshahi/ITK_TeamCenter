...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_MODULE_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_MODULE_MASTER_HXX
...
class TCSOAHRNMODELMNGD_API HRN_Module_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_Module_Master")

   virtual ~HRN_Module_Master();
};
            }
        }
    }
