...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_COFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_COFORM_HXX
...
class TCSOACLIENTMNGD_API COForm : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("COForm")
