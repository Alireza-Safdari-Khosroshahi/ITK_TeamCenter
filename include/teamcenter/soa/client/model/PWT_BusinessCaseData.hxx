...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_PWT_BUSINESSCASEDATA_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_PWT_BUSINESSCASEDATA_HXX
...
class TCSOAGMOMODELMNGD_API PWT_BusinessCaseData : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("PWT_BusinessCaseData")

   virtual ~PWT_BusinessCaseData();
};
            }
        }
    }
