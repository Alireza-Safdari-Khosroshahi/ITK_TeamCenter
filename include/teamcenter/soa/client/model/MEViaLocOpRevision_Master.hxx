...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEVIALOCOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEVIALOCOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEViaLocOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEViaLocOpRevision_Master")

   virtual ~MEViaLocOpRevision_Master();
};
            }
        }
    }
