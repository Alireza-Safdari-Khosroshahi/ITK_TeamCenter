...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MELOCATECOMPOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MELOCATECOMPOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MELocateCompOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MELocateCompOpRevision_Master")

   virtual ~MELocateCompOpRevision_Master();
};
            }
        }
    }
