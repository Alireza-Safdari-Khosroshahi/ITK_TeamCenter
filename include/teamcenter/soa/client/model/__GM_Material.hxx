...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL___GM_MATERIAL_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL___GM_MATERIAL_HXX
...
class TCSOAGMOMODELMNGD_API __GM_Material : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("__GM_Material")

   virtual ~__GM_Material();
};
            }
        }
    }
