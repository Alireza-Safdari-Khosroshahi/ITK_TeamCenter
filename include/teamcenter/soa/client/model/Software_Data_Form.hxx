...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_SOFTWARE_DATA_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_SOFTWARE_DATA_FORM_HXX
...
class TCSOAGMOMODELMNGD_API Software_Data_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Software_Data_Form")

   virtual ~Software_Data_Form();
};
            }
        }
    }
