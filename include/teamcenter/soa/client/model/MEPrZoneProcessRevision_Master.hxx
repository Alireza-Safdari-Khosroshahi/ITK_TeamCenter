...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPRZONEPROCESSREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPRZONEPROCESSREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEPrZoneProcessRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPrZoneProcessRevision_Master")

   virtual ~MEPrZoneProcessRevision_Master();
};
            }
        }
    }
