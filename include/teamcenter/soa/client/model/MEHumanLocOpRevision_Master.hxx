...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEHUMANLOCOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEHUMANLOCOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEHumanLocOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEHumanLocOpRevision_Master")

   virtual ~MEHumanLocOpRevision_Master();
};
            }
        }
    }
