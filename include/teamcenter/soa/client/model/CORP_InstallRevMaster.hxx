...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_INSTALLREVMASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_INSTALLREVMASTER_HXX
...
class TCSOAGMOMODELMNGD_API CORP_InstallRevMaster : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_InstallRevMaster")

   virtual ~CORP_InstallRevMaster();
};
            }
        }
    }
