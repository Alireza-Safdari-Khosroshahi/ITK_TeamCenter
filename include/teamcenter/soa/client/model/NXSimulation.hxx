...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_NXSIMULATION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_NXSIMULATION_HXX
...
class TCSOACLIENTMNGD_API NXSimulation : public Teamcenter::Soa::Client::Model::Dataset
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("NXSimulation")

   virtual ~NXSimulation();
};
            }
        }
    }
