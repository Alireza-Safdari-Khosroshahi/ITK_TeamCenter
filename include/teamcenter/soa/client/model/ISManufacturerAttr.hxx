...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ISMANUFACTURERATTR_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ISMANUFACTURERATTR_HXX
...
class TCSOASPECMGRMODELMNGD_API ISManufacturerAttr : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ISManufacturerAttr")

   virtual ~ISManufacturerAttr();
};
            }
        }
    }
