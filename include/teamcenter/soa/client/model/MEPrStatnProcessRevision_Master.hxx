...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPRSTATNPROCESSREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPRSTATNPROCESSREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEPrStatnProcessRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPrStatnProcessRevision_Master")

   virtual ~MEPrStatnProcessRevision_Master();
};
            }
        }
    }
