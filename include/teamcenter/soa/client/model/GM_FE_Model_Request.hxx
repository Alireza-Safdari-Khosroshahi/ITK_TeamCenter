...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_GM_FE_MODEL_REQUEST_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_GM_FE_MODEL_REQUEST_HXX
...
class TCSOAGMOMODELMNGD_API GM_FE_Model_Request : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("GM_FE_Model_Request")

   virtual ~GM_FE_Model_Request();
};
            }
        }
    }
