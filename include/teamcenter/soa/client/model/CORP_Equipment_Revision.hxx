...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_EQUIPMENT_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_EQUIPMENT_REVISION_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Equipment_Revision : public Teamcenter::Soa::Client::Model::ItemRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Equipment_Revision")

   virtual ~CORP_Equipment_Revision();
};
            }
        }
    }
