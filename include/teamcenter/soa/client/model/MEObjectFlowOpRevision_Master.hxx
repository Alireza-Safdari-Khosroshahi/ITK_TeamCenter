...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEOBJECTFLOWOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEOBJECTFLOWOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEObjectFlowOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEObjectFlowOpRevision_Master")

   virtual ~MEObjectFlowOpRevision_Master();
};
            }
        }
    }
