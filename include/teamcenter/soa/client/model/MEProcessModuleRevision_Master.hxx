...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPROCESSMODULEREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPROCESSMODULEREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEProcessModuleRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEProcessModuleRevision_Master")

   virtual ~MEProcessModuleRevision_Master();
};
            }
        }
    }
