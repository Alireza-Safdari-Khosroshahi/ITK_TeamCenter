...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MATINGCONSTRSTORAGECLASS_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MATINGCONSTRSTORAGECLASS_HXX
...
class TCSOACLIENTMNGD_API MatingConstrStorageClass : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MatingConstrStorageClass")

   virtual ~MatingConstrStorageClass();
};
            }
        }
    }
