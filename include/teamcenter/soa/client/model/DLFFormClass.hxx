...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_DLFFORMCLASS_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_DLFFORMCLASS_HXX
...
class TCSOACLIENTMNGD_API DLFFormClass : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("DLFFormClass")

   virtual ~DLFFormClass();
};
            }
        }
    }
