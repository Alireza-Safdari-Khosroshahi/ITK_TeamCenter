...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_DC_COMPOSEDDOCREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_DC_COMPOSEDDOCREVISION_HXX
...
class TCSOACONTMGMTBASEMODELMNGD_API DC_ComposedDocRevision : public Teamcenter::Soa::Client::Model::DocumentRevision
{
public:
    int get_contentSize();
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("DC_ComposedDocRevision")

   virtual ~DC_ComposedDocRevision();
};
            }
        }
    }
