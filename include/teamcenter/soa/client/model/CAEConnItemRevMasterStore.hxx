...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CAECONNITEMREVMASTERSTORE_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CAECONNITEMREVMASTERSTORE_HXX
...
class TCSOACLIENTMNGD_API CAEConnItemRevMasterStore : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CAEConnItemRevMasterStore")

   virtual ~CAEConnItemRevMasterStore();
};
            }
        }
    }
