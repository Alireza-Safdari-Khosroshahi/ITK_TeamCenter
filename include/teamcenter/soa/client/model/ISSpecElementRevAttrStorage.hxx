...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ISSPECELEMENTREVATTRSTORAGE_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ISSPECELEMENTREVATTRSTORAGE_HXX
...
class TCSOASPECMGRMODELMNGD_API ISSpecElementRevAttrStorage : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ISSpecElementRevAttrStorage")

   virtual ~ISSpecElementRevAttrStorage();
};
            }
        }
    }
