...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_ANALYSISREVMASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_ANALYSISREVMASTER_HXX
...
class TCSOAGMOMODELMNGD_API CORP_AnalysisRevMaster : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_AnalysisRevMaster")

   virtual ~CORP_AnalysisRevMaster();
};
            }
        }
    }
