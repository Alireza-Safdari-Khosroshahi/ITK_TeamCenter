...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_PARTWITHTBMASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_PARTWITHTBMASTER_HXX
...
class TCSOAHRNMODELMNGD_API HRN_PartWithTBMaster : public Teamcenter::Soa::Client::Model::HRN_PartMaster
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_PartWithTBMaster")

   virtual ~HRN_PartWithTBMaster();
};
            }
        }
    }
