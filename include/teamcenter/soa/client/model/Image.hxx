...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_IMAGE_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_IMAGE_HXX
...
class TCSOACLIENTMNGD_API Image : public Teamcenter::Soa::Client::Model::Dataset
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Image")
