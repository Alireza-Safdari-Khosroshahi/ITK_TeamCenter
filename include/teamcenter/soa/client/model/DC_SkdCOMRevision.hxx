...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_DC_SKDCOMREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_DC_SKDCOMREVISION_HXX
...
class TCSOACONTMGMTS1000DMODELMNGD_API DC_SkdCOMRevision : public Teamcenter::Soa::Client::Model::DC_TopicRevision
{
public:
    ...
    const std::string& get_c1k0skddispto_ent_name();
    const std::string& get_c1k0skddispto_div_name();
    const std::string& get_c1k0skddispto_ent_unit();


   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("DC_SkdCOMRevision")

   virtual ~DC_SkdCOMRevision();
};
            }
        }
    }
