...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_ASSEMBLYPART_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_ASSEMBLYPART_HXX
...
class TCSOAHRNMODELMNGD_API HRN_AssemblyPart : public Teamcenter::Soa::Client::Model::Item
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_AssemblyPart")

   virtual ~HRN_AssemblyPart();
};
            }
        }
    }
