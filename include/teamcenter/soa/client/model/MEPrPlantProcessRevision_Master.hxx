...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEPRPLANTPROCESSREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEPRPLANTPROCESSREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEPrPlantProcessRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEPrPlantProcessRevision_Master")

   virtual ~MEPrPlantProcessRevision_Master();
};
            }
        }
    }
