...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MES0MESTRINGPFFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MES0MESTRINGPFFORM_HXX
...
class TCSOACMTMESMODELMNGD_API Mes0MEStringPFForm : public Teamcenter::Soa::Client::Model::Mes0MEPFBaseForm
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Mes0MEStringPFForm")

   virtual ~Mes0MEStringPFForm();
};
            }
        }
    }
