...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_ACCESSORY_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_ACCESSORY_HXX
...
class TCSOAHRNMODELMNGD_API HRN_Accessory : public Teamcenter::Soa::Client::Model::Item
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_Accessory")

   virtual ~HRN_Accessory();
};
            }
        }
    }
