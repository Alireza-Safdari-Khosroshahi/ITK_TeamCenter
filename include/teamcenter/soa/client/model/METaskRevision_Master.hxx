...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_METASKREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_METASKREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API METaskRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("METaskRevision_Master")

   virtual ~METaskRevision_Master();
};
            }
        }
    }
