...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEOBJFLOWLOCOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEOBJFLOWLOCOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEObjFlowLocOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEObjFlowLocOpRevision_Master")

   virtual ~MEObjFlowLocOpRevision_Master();
};
            }
        }
    }
