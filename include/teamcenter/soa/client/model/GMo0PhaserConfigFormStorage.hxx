...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_GMO0PHASERCONFIGFORMSTORAGE_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_GMO0PHASERCONFIGFORMSTORAGE_HXX
...
class TCSOAGMOMODELMNGD_API GMo0PhaserConfigFormStorage : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("GMo0PhaserConfigFormStorage")

   virtual ~GMo0PhaserConfigFormStorage();
};
            }
        }
    }
