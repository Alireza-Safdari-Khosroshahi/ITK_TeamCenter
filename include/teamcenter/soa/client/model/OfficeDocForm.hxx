...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_OFFICEDOCFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_OFFICEDOCFORM_HXX
...
class TCSOACLIENTMNGD_API OfficeDocForm : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("OfficeDocForm")

   virtual ~OfficeDocForm();
};
            }
        }
    }
