...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_DATUMLOCATION_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_DATUMLOCATION_FORM_HXX
...
class TCSOAGMOMODELMNGD_API DatumLocation_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("DatumLocation_Form")

   virtual ~DatumLocation_Form();
};
            }
        }
    }
