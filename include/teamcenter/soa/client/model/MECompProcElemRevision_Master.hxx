...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MECOMPPROCELEMREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MECOMPPROCELEMREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MECompProcElemRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MECompProcElemRevision_Master")

   virtual ~MECompProcElemRevision_Master();
};
            }
        }
    }
