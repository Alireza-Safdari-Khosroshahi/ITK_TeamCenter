...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CPCOMPOCCATTRSTORAGE_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CPCOMPOCCATTRSTORAGE_HXX
...
class TCSOASPECMGRMODELMNGD_API CPCompOccAttrStorage : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CPCompOccAttrStorage")

   virtual ~CPCompOccAttrStorage();
};
            }
        }
    }
