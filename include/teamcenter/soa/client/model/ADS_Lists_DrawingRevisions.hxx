...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_ADS_LISTS_DRAWINGREVISIONS_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_ADS_LISTS_DRAWINGREVISIONS_HXX
...
class TCSOAADSFOUNDATIONMODELMNGD_API ADS_Lists_DrawingRevisions : public Teamcenter::Soa::Client::Model::ImanRelation
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ADS_Lists_DrawingRevisions")

   virtual ~ADS_Lists_DrawingRevisions();
};
            }
        }
    }
