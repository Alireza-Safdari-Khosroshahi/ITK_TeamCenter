...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEWELDLOCOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEWELDLOCOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEWeldLocOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEWeldLocOpRevision_Master")

   virtual ~MEWeldLocOpRevision_Master();
};
            }
        }
    }
