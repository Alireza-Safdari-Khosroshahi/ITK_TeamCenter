...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MES0MEREALDCDFORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MES0MEREALDCDFORM_HXX
...
class TCSOACMTMESMODELMNGD_API Mes0MERealDCDForm : public Teamcenter::Soa::Client::Model::Mes0MEDCDBaseForm
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Mes0MERealDCDForm")

   virtual ~Mes0MERealDCDForm();
};
            }
        }
    }
