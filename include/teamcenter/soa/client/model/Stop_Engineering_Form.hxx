...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_STOP_ENGINEERING_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_STOP_ENGINEERING_FORM_HXX
...
class TCSOAGMOMODELMNGD_API Stop_Engineering_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("Stop_Engineering_Form")

   virtual ~Stop_Engineering_Form();
};
            }
        }
    }
