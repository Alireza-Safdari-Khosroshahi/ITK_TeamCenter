...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_GM_BUILDINTENT_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_GM_BUILDINTENT_HXX
...
class TCSOAGMOMODELMNGD_API GM_BuildIntent : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("GM_BuildIntent")

   virtual ~GM_BuildIntent();
};
            }
        }
    }
