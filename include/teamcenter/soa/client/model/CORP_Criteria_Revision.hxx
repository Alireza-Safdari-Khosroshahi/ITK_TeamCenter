...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_CRITERIA_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_CRITERIA_REVISION_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Criteria_Revision : public Teamcenter::Soa::Client::Model::ItemRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Criteria_Revision")

   virtual ~CORP_Criteria_Revision();
};
            }
        }
    }
