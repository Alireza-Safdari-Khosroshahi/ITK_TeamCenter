...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_SPOTWELD_ATTRIBUTE_FORM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_SPOTWELD_ATTRIBUTE_FORM_HXX
...
class TCSOACLIENTMNGD_API SpotWeld_Attribute_Form : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("SpotWeld_Attribute_Form")

   virtual ~SpotWeld_Attribute_Form();
};
            }
        }
    }
