...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFHEXREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFHEXREVISION_HXX
...
class TCSOACCDMMODELMNGD_API ParmDefHexRevision : public Teamcenter::Soa::Client::Model::ParmDefRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ParmDefHexRevision")

   virtual ~ParmDefHexRevision();
};
            }
        }
    }
