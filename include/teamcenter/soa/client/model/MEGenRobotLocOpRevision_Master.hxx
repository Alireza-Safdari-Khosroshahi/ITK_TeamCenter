...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEGENROBOTLOCOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEGENROBOTLOCOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEGenRobotLocOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEGenRobotLocOpRevision_Master")

   virtual ~MEGenRobotLocOpRevision_Master();
};
            }
        }
    }
