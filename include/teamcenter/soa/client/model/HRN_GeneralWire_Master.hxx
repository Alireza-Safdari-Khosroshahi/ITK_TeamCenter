...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_HRN_GENERALWIRE_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_HRN_GENERALWIRE_MASTER_HXX
...
class TCSOAHRNMODELMNGD_API HRN_GeneralWire_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("HRN_GeneralWire_Master")

   virtual ~HRN_GeneralWire_Master();
};
            }
        }
    }
