...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_MEGENROBOTICOPREVISION_MASTER_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_MEGENROBOTICOPREVISION_MASTER_HXX
...
class TCSOACMTEMSERVERMODELMNGD_API MEGenRoboticOpRevision_Master : public Teamcenter::Soa::Client::Model::Form
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("MEGenRoboticOpRevision_Master")

   virtual ~MEGenRoboticOpRevision_Master();
};
            }
        }
    }
