...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CORP_ANALYSIS_REVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CORP_ANALYSIS_REVISION_HXX
...
class TCSOAGMOMODELMNGD_API CORP_Analysis_Revision : public Teamcenter::Soa::Client::Model::ItemRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CORP_Analysis_Revision")

   virtual ~CORP_Analysis_Revision();
};
            }
        }
    }
