...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_CAEGEOM_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_CAEGEOM_HXX
...
class TCSOACLIENTMNGD_API CAEGeom : public Teamcenter::Soa::Client::Model::Dataset
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("CAEGeom")
