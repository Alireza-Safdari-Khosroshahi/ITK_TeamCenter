...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFSTRREVISION_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_PARMDEFSTRREVISION_HXX
...
class TCSOACCDMMODELMNGD_API ParmDefStrRevision : public Teamcenter::Soa::Client::Model::ParmDefRevision
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("ParmDefStrRevision")

   virtual ~ParmDefStrRevision();
};
            }
        }
    }
