...
#ifndef TEAMCENTER_SOA_CLIENT_MODEL_WDM0SURFACEADDFORMCLASS_HXX
#define TEAMCENTER_SOA_CLIENT_MODEL_WDM0SURFACEADDFORMCLASS_HXX
...
class TCSOAWELDMGMTMODELMNGD_API WdM0SurfaceAddFormClass : public Teamcenter::Soa::Client::Model::POM_object
{
public:
   ...
   SOA_CLASS_NEW_OPERATORS_WITH_IMPL("WdM0SurfaceAddFormClass")

   virtual ~WdM0SurfaceAddFormClass();
};
            }
        }
    }
