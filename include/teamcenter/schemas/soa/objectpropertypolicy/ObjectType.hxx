...
#ifndef TEAMCENTER__SCHEMAS__SOA__OBJECTPROPERTYPOLICY_OBJECTTYPE_HXX
#define TEAMCENTER__SCHEMAS__SOA__OBJECTPROPERTYPOLICY_OBJECTTYPE_HXX
    ...
    namespace Schemas
    {
        namespace Soa
        {
            namespace Objectpropertypolicy
            {
                    ...
                    class ObjectType;
                    typedef std::vector< Teamcenter::Soa::Common::AutoPtr<ObjectType> > ObjectTypeArray;
                    class Property;
...
class TCSOACOMMON_API Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectType : 
        public Teamcenter::Soa::Common::Xml::BaseObject 
{
 public:
    ...
    const std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::Property> >& getPropertyArray() const;
    void setPropertyArray( const std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::Property> >& property );
    void addProperty( const Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::Property>& property );


    virtual void outputXML( Teamcenter::Soa::Common::Xml::XmlStream& out ) const { outputXML( out, "ObjectType" ); }
...
protected:
    virtual ObjectType* reallyClone();
    ...
    std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::Property> >   m_Property;
