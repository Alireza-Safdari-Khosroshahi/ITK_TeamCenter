...
#ifndef TEAMCENTER__SCHEMAS__SOA__OBJECTPROPERTYPOLICY_OBJECTPROPERTYPOLICY_HXX
#define TEAMCENTER__SCHEMAS__SOA__OBJECTPROPERTYPOLICY_OBJECTPROPERTYPOLICY_HXX
...
class TCSOACOMMON_API Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectPropertyPolicy : 
        public Teamcenter::Soa::Common::Xml::BaseObject 
{
 public:
    ...
    const std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectType> >& getObjectTypeArray() const;
    void setObjectTypeArray( const std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectType> >& objectType );
    void addObjectType( const Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectType>& objectType );
...
protected:
    ...
    std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Schemas::Soa::Objectpropertypolicy::ObjectType> >   m_ObjectType;
