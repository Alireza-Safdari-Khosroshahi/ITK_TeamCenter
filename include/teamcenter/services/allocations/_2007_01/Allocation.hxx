...
#ifndef TEAMCENTER_SERVICES_ALLOCATIONS__2007_01_ALLOCATION_HXX
#define TEAMCENTER_SERVICES_ALLOCATIONS__2007_01_ALLOCATION_HXX

#include <teamcenter/soa/client/model/AllocationLine.hxx>
#include <teamcenter/soa/client/model/AllocationMap.hxx>
#include <teamcenter/soa/client/model/AllocationMapRevision.hxx>
#include <teamcenter/soa/client/model/AllocationWindow.hxx>
...
public:
    ...
    struct AllocationContextInput;
    struct AllocationLineInfo;
    struct AllocationLineInput;
    struct AllocationWindowInfo;
    struct GetAllocatedBOMViewInfo;
    struct GetAllocatedBOMViewResponse;
    struct GetAllocationWindowResponse;

    /**
     * The <i>AllocationContextInput</i> structure represents all the data necessary for
    ...
    struct AllocationContextInput
    {
         ...
         * Allocations created between the <b>BOMLine</b> objects of these <b>BOMWindow</b>
         * objects.
         */
    ...
    /**
     * The <i>AllocationLineInfo</i> structure represents all of the data necessary to construct
     * the <b>AllocationLine</b> object. The basic attributes that are required by ITK are
     * passed as named elements in the structure.
     */
    struct AllocationLineInfo
    {
        /**
         * The <b>AllocationLine</b> name for creation, optional if empty, generated on server.
         */
        std::string name;
        /**
         * The <b>AllocationLine</b> type, if empty then the default type <i>Allocation</i>
         * is used.
         */
        std::string type;
        /**
         * The <b>AllocationLine</b> reason, optional.
         */
        std::string reason;
        /**
         * AllocateFrom <b>BOMLine</b> objects, required.
         */
        std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::BOMLine>  > fromBOMLines;
        /**
         * AllocateTo <b>BOMLine</b> objects, required.
         */
        std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::BOMLine>  > toBOMLines;
    };

    /**
     * The <i>AllocationLineInput</i> structure contains all the elements necessary for
     * the identifying an <b>AllocationLine</b> object, including <i>AllocationLineInfo</i>
     * structure as well as an object reference to the <b>AllocationLine</b> itelf.
     */
    struct AllocationLineInput
    {
        /**
         * <b>AllocationLine</b> object which needs to be modified.
         */
        Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::AllocationLine>  allocationLine;
        /**
         * <i>AllocationLineInfo</i> element containing all information necessary for modification
         * of the <b>AllocationLine</b> object.
         */
        Teamcenter::Services::Allocations::_2007_01::Allocation::AllocationLineInfo allocationLineInfo;
    };

    /**
     * The <i>AllocationWindowInfo</i> structure represents all of the data necessary for
     * opening an <b>AllocationWindow</b>. The basic attributes that are required by ITK
     * are passed as named elements in the structure.
     */
    struct AllocationWindowInfo
    {
        /**
         * AllocationContext Object, can be <b>AllocationMap</b> or <b>AllocationMapRevision</b>
         * businessobject.
         */
    ...
    /**
     * The GetAllocatedBOMViewInfo structure is used as a mapping between the <b>AllocationMap</b>
     * <br>
     * object and its corresponding allocated <b>BOMView</b> Objects.
     */
    struct GetAllocatedBOMViewInfo
    {
        /**
         ...
         */
        Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::AllocationMap>  allocationMap;
        /**
         * A list of PSBOMView business objects associated to the AllocationMap object.
         */
        std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::PSBOMView>  > allocatedBOMViewObjects;
    };

    /**
     * The <i>GetAllocatedBOMViewResponse</i> structure contains a list of the structure
     * <i>GetAllocatedBOMViewInfo</i> and Service Data. Any errors are reported in ServiceData.
     */
    struct GetAllocatedBOMViewResponse
    {
        /**
         * Structure which contains the <b>AllocationMap</b> business object and a list of associated
         * <b>PSBOMView</b> objects.
         */
        std::vector< Teamcenter::Services::Allocations::_2007_01::Allocation::GetAllocatedBOMViewInfo > allocatedBOMViewInfo;
        /**
         * The ServiceData.
         */
    ...
    /**
     * The <i>GetAllocationWindowResponse</i> structure represents the current state of
     * the <b>BOMWindow</b> as well as the list of <b>AllocationLine</b> objects contained
     * in said <b>BOMWindow</b>.
     */
    struct GetAllocationWindowResponse
    {
        /**
         * The Business Object corresponding to the <b>AllocationWindow</b>.
         */
        Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::AllocationWindow>  allocationWindow;
        /**
         * <b>AllocationLine</b> objects for the modified <b>AllocationWindow</b>.
         */
        std::vector< Teamcenter::Soa::Common::AutoPtr<Teamcenter::Soa::Client::Model::AllocationLine>  > allocationLines;
        /**
         * ServiceData contains the created <b>AllocationMap</b>, <b>AllocationMapRevision</b>,
         * and <b>AllocationWindow</b>  created in the created objects of list of the ServiceData
